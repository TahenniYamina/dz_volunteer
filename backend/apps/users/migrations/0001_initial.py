    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_slogan', models.CharField(blank=True, max_length=200, null=True)),
                ('organization_logo', models.ImageField(blank=True, null=True, upload_to='organizations/logos/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('skills', models.ManyToManyField(related_name='users', through='skills.UserSkill', to='skills.skill')),
